...
// generated by pgtalk-gen on 2021-08-18 16:34:59.233396 &#43;0200 CEST m=&#43;0.064959987
// DO NOT EDIT
...
var (
	...
	tableAccess = pgtalk.TableAccessor{TableInfo: tableInfo, AllColumns: []pgtalk.ColumnAccessor{TDate, TTimestamp, TJSON, ID}}
)
...
func Select(cas ...pgtalk.ColumnAccessor) ThingsQuerySet {
	return ThingsQuerySet{pgtalk.MakeQuerySet(tableAccess, cas, func() interface{} {
		return new(Thing)
	})}
}
...
func (s ThingsQuerySet) Having(expr pgtalk.SQLWriter) ThingsQuerySet {
