package things
// generated by pgtalk-gen on 2021-07-14 11:47:43.818664 &#43;0200 CEST m=&#43;0.027167058 
// DO NOT EDIT
...
var (	
	...
	TJSON = pgtalk.NewBytesAccess(tableInfo, "tJSON", func(dest interface{}, v *[]byte) { dest.(*Thing).TJSON = v })	
	ID = pgtalk.NewInt64Access(tableInfo, "id", func(dest interface{}, v *int64) { dest.(*Thing).ID = v })
)
