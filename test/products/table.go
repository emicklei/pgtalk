...
type Product struct {
	ID	int64 // id : integer
	CreatedAt	sql.NullTime // created_at : timestamp with time zone
	UpdatedAt	sql.NullTime // updated_at : timestamp with time zone
	DeletedAt	sql.NullTime // deleted_at : timestamp with time zone
	Code	sql.NullString // code : text
	Price	sql.NullInt64 // price : bigint
	CategoryId	sql.NullInt64 // category_id : bigint
}
...
var (	
	...
	CreatedAt = p.NewTimeAccess(p.MakeColumnInfo(tableInfo, "created_at", p.NotPrimary, p.Nullable, 2),
			nil, func(dest interface{}, v sql.NullTime) { dest.(*Product).CreatedAt = v })	
	...
	UpdatedAt = p.NewTimeAccess(p.MakeColumnInfo(tableInfo, "updated_at", p.NotPrimary, p.Nullable, 3),
			nil, func(dest interface{}, v sql.NullTime) { dest.(*Product).UpdatedAt = v })	
	...
	DeletedAt = p.NewTimeAccess(p.MakeColumnInfo(tableInfo, "deleted_at", p.NotPrimary, p.Nullable, 4),
			nil, func(dest interface{}, v sql.NullTime) { dest.(*Product).DeletedAt = v })	
	...
	Code = p.NewTextAccess(p.MakeColumnInfo(tableInfo, "code", p.NotPrimary, p.Nullable, 5),
			nil, func(dest interface{}, v sql.NullString) { dest.(*Product).Code = v })	
	...
	Price = p.NewInt64Access(p.MakeColumnInfo(tableInfo, "price", p.NotPrimary, p.Nullable, 6),
			nil, func(dest interface{}, v sql.NullInt64) { dest.(*Product).Price = v })	
	...
	CategoryId = p.NewInt64Access(p.MakeColumnInfo(tableInfo, "category_id", p.NotPrimary, p.Nullable, 7),
			nil, func(dest interface{}, v sql.NullInt64) { dest.(*Product).CategoryId = v })
	// package private
	_ = time.Now
...
func (e *Product) SetCreatedAt(v sql.NullTime) *Product { e.CreatedAt = v ; return e }

// SetUpdatedAt set the address of the value to the field value and returns the receiver.
func (e *Product) SetUpdatedAt(v sql.NullTime) *Product { e.UpdatedAt = v ; return e }

// SetDeletedAt set the address of the value to the field value and returns the receiver.
func (e *Product) SetDeletedAt(v sql.NullTime) *Product { e.DeletedAt = v ; return e }

// SetCode set the address of the value to the field value and returns the receiver.
func (e *Product) SetCode(v sql.NullString) *Product { e.Code = v ; return e }

// SetPrice set the address of the value to the field value and returns the receiver.
func (e *Product) SetPrice(v sql.NullInt64) *Product { e.Price = v ; return e }

// SetCategoryId set the address of the value to the field value and returns the receiver.
func (e *Product) SetCategoryId(v sql.NullInt64) *Product { e.CategoryId = v ; return e }
...
func (e *Product) Setters() (list []p.ColumnAccessor) {
	...
	if e.CreatedAt.Valid {
		list = append(list, CreatedAt.Set(e.CreatedAt.Time))
	}
	if e.UpdatedAt.Valid {
		list = append(list, UpdatedAt.Set(e.UpdatedAt.Time))
	}
	if e.DeletedAt.Valid {
		list = append(list, DeletedAt.Set(e.DeletedAt.Time))
	}
	if e.Code.Valid {
		list = append(list, Code.Set(e.Code.String))
	}
	if e.Price.Valid {
		list = append(list, Price.Set(e.Price.UNKOWN:bigint))
	}
	if e.CategoryId.Valid {
		list = append(list, CategoryId.Set(e.CategoryId.UNKOWN:bigint))
	}	
	return
}
