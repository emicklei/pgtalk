package categories
// generated by github.com/emicklei/pgtalk/cmd/pgtalk-gen from version: v1.9.3+dirty 
// DO NOT EDIT
...
type Category struct {
	...
	TitleTokens	string // title_tokens : tsvector
...
var (	
	...
	// TitleTokens represents the column "title_tokens" of with type "tsvector", nullable:true, primary:false
	TitleTokens = p.NewTSVectorWriter(p.MakeColumnInfo(tableInfo, "title_tokens", p.NotPrimary, p.Nullable, 0),
		func(dest any) any { return &dest.(*Category).TitleTokens })
	// package private
...
func init() {
	...
	tableInfo.Columns = []p.ColumnAccessor{ID,Title,TitleTokens, }
}
...
// SetTitleTokens sets the value to the field value and returns the receiver.
func (e *Category) SetTitleTokens(v string) *Category { e.TitleTokens = v ; return e }
...
func (e *Category) Setters() (list []p.ColumnAccessor) {
	...
	if e.TitleTokens.Valid {
			list = append(list, TitleTokens.Set(e.TitleTokens))
	}	
	return
}
